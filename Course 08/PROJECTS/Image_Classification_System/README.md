...
**Step-by-step guide:** See **`PROJECT_GUIDE.md`** in this folder for a complete walkthrough from data loading to deployment, with code snippets and troubleshooting tips.
