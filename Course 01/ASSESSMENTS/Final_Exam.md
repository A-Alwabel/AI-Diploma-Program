...
B) Traditional AI uses explicit rules, modern AI learns from data  
C) Traditional AI is faster, modern AI is slower  
...
B) Rules, facts, and inference mechanisms  
C) Only databases  
D) Only algorithms
...
B) Handling uncertainty and making probabilistic inferences  
C) Only regression  
D) Only clustering
