# Quiz 00: Python Libraries for AI
...
- A) Displays the plot on screen
- B) Saves the plot to a file
- C) Clears the plot
- D) Updates the plot
...
- B) It's faster for append/pop operations
...
- D) Adds an element maintaining heap property
